...
>) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-9 items-center justify-center border-y border-r border-input text-sm shadow-xs transition-all outline-none first:rounded-l-md first:border-l last:rounded-r-md aria-invalid:border-destructive data-[active=true]:z-10 data-[active=true]:border-blue-2 data-[active=true]:aria-invalid:border-destructive dark:bg-input/30",
        className
      )}
      {...props}
    >
