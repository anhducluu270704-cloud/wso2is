...
import { useIsMobile } from '@/share/hooks/use-mobile'
...
import { Tooltip, TooltipContent, TooltipTrigger } from '@/share/ui/tooltip'
        ...
        <CollapsibleContent>
          <SidebarMenuSub>
            {item.items?.map((subItem) => (
              <SidebarMenuSubItem
                key={subItem.title}
                className={cn(pathname === subItem.url && 'bg-sidebar-accent')}
              >
