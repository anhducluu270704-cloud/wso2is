...
>) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "w-full border border-grey-1/29 data-[placeholder]:text-grey-4 dark:bg-input/30 dark:hover:bg-input/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 gap-1.5 rounded-md bg-transparent px-4 text-body-body text-black-1 transition-[color,box-shadow] aria-invalid:ring-[3px] data-[size=default]:h-11 data-[size=sm]:h-10 *:data-[slot=select-value]:flex *:data-[slot=select-value]:gap-1.5 [&_svg:not([class*='size-'])]:size-5 flex items-center justify-between whitespace-nowrap outline-none disabled:cursor-not-allowed disabled:opacity-50 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:text-black-1 cursor-pointer",
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="text-black-1 size-4 pointer-events-none" />
