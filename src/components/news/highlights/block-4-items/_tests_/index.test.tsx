...
import { HighlightBlock4Items } from '../index'
...
describe('news/highlights/block-4-items', () => {
  beforeEach(() => onClick.mockClear())

  it('renders big and small cards and triggers click', async () => {
    const user = userEvent.setup()
    render(
      <HighlightBlock4Items
        items={[
          mkNews('1', 'T1'),
          mkNews('2', 'T2'),
          mkNews('3', 'T3'),
